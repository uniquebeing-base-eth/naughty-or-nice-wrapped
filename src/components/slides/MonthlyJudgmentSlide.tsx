        ...
        <div className="relative z-10">
          ...
          <div className={`relative w-36 h-36 mx-auto mb-4 transition-all duration-1000 delay-500 ${animate ? 'opacity-100 scale-100' : 'opacity-0 scale-50'}`}>
            ...
            <div 
              ...
              style={{ top: '8px', left: '8px', right: '8px', bottom: '8px', backgroundColor: '#2a1010' }}
            />
            <div 
          ...
          <div 
            className={`inline-flex items-center gap-2 px-4 py-2 rounded-full text-white font-bold text-sm mb-3 transition-all duration-700 delay-700 shadow-lg ${animate ? 'opacity-100 scale-100' : 'opacity-0 scale-75'}`}
            style={{
          ...
          <p className={`text-sm text-christmas-snow/90 whitespace-pre-line mb-3 transition-all duration-700 delay-800 ${animate ? 'opacity-100' : 'opacity-0'}`}>
            {description}
          </p>

          <div className={`flex justify-center gap-8 text-xs transition-all duration-700 delay-900 ${animate ? 'opacity-100' : 'opacity-0'}`}>
            <div>
